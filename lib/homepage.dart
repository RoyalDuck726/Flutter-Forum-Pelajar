              ...
              content: Column(
                ...
                children: [
                  TextField(
                    ...
                    decoration: const InputDecoration(hintText: "Tulis pertanyaan Anda di sini"),
                  ),
...
class QuestionTile extends StatelessWidget {
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(question.text, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          const Text('Pinned Answer', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                          IconButton(
                      ...
                      Text(question.pinnedAnswer!.text, style: const TextStyle(color: Colors.white)),
                      Text('By: ${question.pinnedAnswer!.poster}', style: const TextStyle(color: Colors.white70, fontSize: 12)),
                    ],
                  ),
                ),
              ),
  ...
  void _showAddAnswerDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Tambah Jawaban'),
          content: TextField(
            onChanged: (value) {
              newAnswer = value;
            },
            decoration: const InputDecoration(hintText: "Tulis jawaban Anda di sini"),
          ),
          actions: <Widget>[
            ElevatedButton(
              style: ElevatedButton.styleFrom(
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Text('${answer.upvotes}', style: const TextStyle(fontSize: 12)),
                IconButton(
                  icon: Icon(
                    Icons.arrow_downward,
                ...
                Text('${answer.downvotes}', style: const TextStyle(fontSize: 12)),
              ],
            ),
